-- COMPLETE Database Schema for Rent Management System with Foreign Keys
...
CREATE TABLE IF NOT EXISTS documents (
    ...
    lease_id VARCHAR REFERENCES leases(id) ON DELETE CASCADE,
    name VARCHAR NOT NULL,
...
WHERE schemaname = 'public' 
    AND tablename IN ('users', 'properties', 'units', 'tenants', 'leases', 'payments', 'maintenance_requests', 'documents', 'sessions')
ORDER BY tablename;

-- Success message
SELECT 'Database schema created successfully! All tables with foreign keys and indexes are ready.' as result;
