...
const navSections = [
  {
    ...
    items: [
      ...
      { id: "properties", label: "Properties", icon: "fas fa-building", roles: ["landlord", "property_manager", "caretaker"] },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "subscription", label: "Subscription", icon: "fas fa-credit-card", roles: ["landlord", "property_manager"] },
