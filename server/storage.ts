  ...
  async getTenantsByOwnerId(ownerId: string): Promise<Tenant[]> {
    return await db
      .select({
        ...
        assignedUnitId: tenants.assignedUnitId,
        assignedStartDate: tenants.assignedStartDate,
        assignedEndDate: tenants.assignedEndDate,
        assignedMonthlyRent: tenants.assignedMonthlyRent,
        assignedSecurityDeposit: tenants.assignedSecurityDeposit,
        assignedAt: tenants.assignedAt,
        assignedBy: tenants.assignedBy,
